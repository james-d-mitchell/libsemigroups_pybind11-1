...
by this function.If the :any:`ToddCoxeterBase` instance was constructed
...
:raises LibsemigroupsError:  if *i* is out of bounds.
      ...
      def_partition<ToddCoxeter<Word>>(m, "todd_coxeter");
      def_non_trivial_classes<ToddCoxeter<Word>>(m, "todd_coxeter");
