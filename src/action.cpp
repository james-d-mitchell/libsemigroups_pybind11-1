...
be a right action.
    ...
    bind_action<LeastPPerm<16>,
                LeastPPerm<16>,
                ImageRightAction<LeastPPerm<16>, LeastPPerm<16>>,
                ActionTraits<LeastPPerm<16>, LeastPPerm<16>>,
                side::right>(m, "RightActionPPerm16PPerm16");
    bind_action<LeastPPerm<16>,
                LeastPPerm<16>,
                ImageLeftAction<LeastPPerm<16>, LeastPPerm<16>>,
                ActionTraits<LeastPPerm<16>, LeastPPerm<16>>,
